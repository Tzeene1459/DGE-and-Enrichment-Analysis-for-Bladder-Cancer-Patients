---
title: "Enrichment Analysis for Bladder Cancer: Stage1 vs Precancerous"
...
fileName <- "input/Tazeen_Stage1_Precancerous_Ttest_Shortlisted.csv"
...
table(which1) #11292 genes with p <= 0.05 and fdr <= 0.01
...
```
```{r}
geneList_final_df <- data.frame(Gene = geneListFinal)
...
outputFileName1 <- paste("output/Tazeen-Team4-Step2-Stage1_Precancerous.", "_EnrichR.xlsx", sep="")

#Load R script into the environment
source(file = "functionEnrichment.R") 

#call function to run Enrichment
functionEnrichment(dblist1, geneList_final_df, outputFileName1)
